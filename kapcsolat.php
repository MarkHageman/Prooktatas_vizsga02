...
<body>
    ...
    <main class="container contact">
        <h2>Magna Hungaria Kulturális Szolgáltató<br> és Kereskedelmi Bt.</h2>
        <div class="row">
            <div class="contact-card col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5 m-1 p-2">
                <h3>Wenzdorfer Ákos</h3>
                <p>kiadóvezető és író</p>
                <p><a href="tel:+36903219801">06-90-506-5441</a></p>
            </div>
            <div class="contact-card col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5 m-1 p-2">
                <h3>Gajda Anett</h3>
                <p>irodavezető</p>
                <p><a href="tel:+36904560601">06-90-456-0601</a></p>
            </div>
        </div>
        <div class="row">
            <div class="contact-card col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5 m-1 p-2">
                <h3>Cím</h3>
                <p><a href="">2800 Tatabánya, Tas vezér u. 9
                    3/12.(kaputelefon: 12)</a></p>
            </div>
            <div class="contact-card col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5 m-1 p-2">
                <h3>Telefon</h3>
                <p><a href="tel:+36349817600">06-90-321-9801</a></p>
            </div>
        </div>
        <div class="row">
            <div class="contact-card col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5 m-1 p-2">
                <h3>E-mail</h3>
                <p><a href="mailto:info@magnahungaria.hu">info@magnahungaria.hu</a></p>
            </div>
            <div class="contact-card col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 col-xxl-5 m-1 p-2">
                <h3>Cégadatok</h3>
                <p><strong>Adószám:</strong><br>50369419-2-56</p>
                <p><strong>Banszámla:</strong><br>18941298-98456732-00000000</p>
            </div>
        </div>
